...
platform_x_img = pygame.image.load('img2/a/estructura_9.png')
platform_y_img = pygame.image.load('img2/a/estructura_9.png')
lava_img = pygame.image.load('img/lava.png')
apple_img = pygame.image.load('img2/apple.png')
...
# Dibujar en la pantalla de juego
...
while run:
	...
	# Cargar y guardar nuestro nivel
	if save_button.draw():
  ...
  # dibujar la malla y mostrar los tiles
	draw_grid()
	draw_world()


	# Texto para mostrar nivel actual
	...
	for event in pygame.event.get():
		...
		if event.type == pygame.QUIT:
			run = False
		# Cambiar tiles con cada click
		if event.type == pygame.MOUSEBUTTONDOWN and clicked == False:
			clicked = True
			pos = pygame.mouse.get_pos()
			x = pos[0] // tile_size
			y = pos[1] // tile_size
			# Verificar coordenadas que esten en el area tile
			if x < 20 and y < 20:
				# Actualizar valor del tile
		...
		if event.type == pygame.MOUSEBUTTONUP:
			clicked = False
    # Cambiar de nivel con tecla arriba y abajo
